...
Excited to share my latest GenAI hands-on project: **Enterprise RAG Knowledge Assistant** 🚀

Built an end-to-end **Generative AI (GenAI) Retrieval-Augmented Generation (RAG) pipeline** using **LangChain, OpenAI API, and Vector Database** to enable context-aware question answering over enterprise documents.
...
Tech Stack: **Python | LangChain | OpenAI API | Vector DB | GenAI | RAG**

#GenAI #RAG #LangChain #OpenAI #LLM #ArtificialIntelligence #MachineLearning #DataEngineering #Python #VectorDatabase #SemanticSearch #LearningInPublic
